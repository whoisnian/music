...
$TABS = '
      ...
      <a href="#search_album" class="mdl-layout__tab mdl-navigation__link"><i class="material-icons">album</i> 专辑详情</a>
		  <a href="#search_playlist" class="mdl-layout__tab mdl-navigation__link"><i class="material-icons">list</i> 歌单详情</a>
		</div>';
$OTHERSTYLE = '
	<style>
	.center {
		...
		<section class="mdl-layout__tab-panel wide" id="search_album">
		  <form class="mdl-cell center" action="./albums.php" method="post">
		    ...
		    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label wide">
			    ...
			    <label class="mdl-textfield__label" for="album">请输入专辑ID</label>
			  </div><br/>
			  <input class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" type="submit" name="submit" value="专辑详情"><br/>
		  </form>
		</section>
		<section class="mdl-layout__tab-panel wide" id="search_playlist">
		  <form class="mdl-cell center" action="./playlists.php" method="post">
		    ...
		    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label wide">
			    ...
			    <label class="mdl-textfield__label" for="playlist">请输入歌单ID</label>
			  </div><br/>	
			  <input class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" type="submit" name="submit" value="歌单详情"><br/>
		  </form>
		</section>';
